...
##.Describe the distribution of streak lengths. What is the typical streak length for this 
        # The distribution of the stream length is right skewed. Meaning there are a fewer streaks that are above 3
       #The typical streak length for the simulated player is 0
