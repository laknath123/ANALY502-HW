...
# right skewed. Fewer number of houses with square feet above 3000 sqft
...
# 4.How many elements are there in  sample_means50 ? 5000 elements
...
# sample_means_small ? What does each element represent? 100 elements, each represent a sample mean
...
mean(sample_means50) #sampling mean
...
#there is less variation or the sampling distribution with the bigger sample size has a smaller
#standard deviation
...
# The one with 150 sample size has a smaller spread. If we want to make an estimate we 
